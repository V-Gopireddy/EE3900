...
%
\begin{lstlisting}
https://github.com/V-gopireddy/EE3900/blob/main/GATE_Assignment4/GateAssignment-4.tex
\end{lstlisting}
...
\end{align}
Since $e^{j2\pi ft}$ has no units.
The units of $X(f)$ will be the product of units of $x(t)$ and $dt$.\\
